...
const Main = () => {
  return (
    <main className="bg-primary p-2">
      <div className="h-30 w-30 rounded-full overflow-hidden mt-30 mx-auto">
      ...
      <p className="text-muted text-sm mt-2 text-center">While crafting premium digital experiences with modern technologies. I enjoy creating fast, secure and reliable solutions</p>
      ...
      <div className="mt-10">
        <div className="py-8 px-4 bg-box border-1 border-border rounded-md w-[90%] md:w-[500px] mx-auto">
      ...
      <h1 className="text-accent text-center font-inter text-lg">What I've Been Up To</h1>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5 w-[90%] md:w-[800px]  mx-auto">
        <div className="p-4 bg-box border-1 border-border rounded-md">
